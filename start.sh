...
export BUCKET_NAME=$(terragrunt output -raw --working-dir "tesseract/deployment/live/aws/test" s3_bucket_name)
export DB_HOST=$(terragrunt output -raw --working-dir "tesseract/deployment/live/aws/test" rds_aurora_cluster_endpoint)
